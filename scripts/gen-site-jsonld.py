...
PAGES = [
    {
        ...
        "description": "XrayTun 是面向 macOS 13 及以上的 Xray 图形客户端，使用 Xray-core 原生 TUN 入站接管系统流量，支持 vmess / vless / trojan / shadowsocks 节点、四种订阅格式、geoip/geosite 分流与 Fake-IP。当前版本 v0.8.29，通用包（Apple Silicon + Intel），包内自带 Xray 核心。",
    ...
    },
    {
        ...
        "name": "XrayTun",
        "version": XRAYTUN_VERSION,
        "description": "XrayTun is an Xray GUI client for macOS 13 and later. It uses Xray-core's native TUN inbound to take over system traffic, supports vmess / vless / trojan / shadowsocks nodes, four subscription formats, geoip/geosite routing and Fake-IP. Current version v0.8.29, universal build (Apple Silicon + Intel), Xray core included.",
        "os": "macOS 13.0 or later",
        "faq_must_contain": ["MPL-2.0"],
    },
    {
