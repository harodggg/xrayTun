...
|---|---|---|---|
| 1 | 点「下载 dmg」 | 按钮旁边写**版本号 + 大小 + 文件名**：`v0.8.28 · 47.1 MB（45.0 MiB）· XrayTun_0.8.28_x86_64_arm64.dmg`，并给 zip 备用链接与 SHA256 入口 | 【实测·真机】`gh release view v0.8.26`：dmg = 47,128,987 B、zip = 42,636,964 B、`SHA256SUMS.txt` 200 B、`isDraft: false`、`publishedAt: 2026-09-20` |
...
6. **版本号会过期**：本文所有版本数据取自 `gh release view v0.8.28`（2026-09-20T16:03:44Z，`isDraft: false`）。
